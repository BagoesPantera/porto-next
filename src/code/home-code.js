const homeCode = `import TypeIt from "typeit-react";
      ...
      <>
         <div className="mb-4 pl-5 items-center lg:h-[90vh] flex flex-col-reverse lg:flex-row">
            <div className="flex flex-col gap-1 items-start justify-start rounded bg-gray-50 h-50 space-y-4 lg:w-[75%]">
               ...
               <span className="text-6xl font-bold">Bagoes Pantera</span>
               <div className="flex text-gray-600 text-base">
                  <span>a </span>
                  <TypeIt
                     className="ms-3"
                     options={{ speed: 200, loop: true }}
            ...
            <div className="flex items-center justify-center bg-gray-50 h-[40vh] w-[50%]">
               <Image src={photo} alt="Bagoes Pantera" className="rounded" />
            </div>
         </div>
      </>
   );
