    ...
    return (
        <>
            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full overflow-y-auto bg-gray-200 dark:bg-gray-800">
                    <ul>
                        <li>
                            <a href="#" className="flex items-center py-2 pl-2 text-gray-900 dark:text-white bg-gray-300 font-bold">
